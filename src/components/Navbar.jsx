      ...
      <div className="flex justify-between items-center h-full w-full px-4 lg:px-20">
        ...
        <div className="hidden sm:flex">
          <ul className="hidden sm:flex font-bold gap-x-8">
            <Link href={'/'} className="flex hover:text-rose-700 transition ease-in-out duration-200">
              <Image
                src={'/About.png'}
                width={20}
                height={20}
      ...
      <div
        ...
        <div className="flex-col py-4">
          <ul className="font-bold">
            <Link href={'/about'} className="mb-4 flex hover:bg-zinc-300 hover:rounded-md py-3 px-2 transition ease-in-out duration-200">
              <Image
                src={'/About.png'}
                width={20}
                height={20}
            ...
            <Link href={'/services'} className="flex hover:bg-zinc-300 hover:rounded-md py-3 px-2 transition ease-in-out duration-200">
              <Image
                src={'/Contact.png'}
                width={20}
                height={20}
